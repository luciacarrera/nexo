...
// MARK: Photo Struct
// Stores the data needed to create a Photo
...
public class CameraService {
    ...
    @Published public var photosSaved = false
    ...
    // Function that checks that the user has all the needed permissions
    public func checkForPermissions() {
        ...
        default:
            ...
            DispatchQueue.main.async {
                self.alertError = AlertError(title: "Camera Access", message: "NEXO doesn't have access to use your camera, please update your privacy settings.", primaryButtonTitle: "Settings", secondaryButtonTitle: nil, primaryAction: {
        ...
        PHPhotoLibrary.requestAuthorization { status in
            if status != .authorized {
                ...
                DispatchQueue.main.async {
                    self.alertError = AlertError(title: "Photo Library Access", message: "NEXO doesn't have access to use your photo library, please update your privacy settings.", primaryButtonTitle: "Settings", secondaryButtonTitle: nil, primaryAction: {
                            UIApplication.shared.open(URL(string: UIApplication.openSettingsURLString)!,
                                                      options: [:], completionHandler: nil)
    ...
    public func changeCamera() {
        // Here disable all camera operation related buttons due to configuration is due upon and must not be interrupted
        DispatchQueue.main.async {
            self.isCameraButtonDisabled = true
        }
        ...
        sessionQueue.async {
            ...
            DispatchQueue.main.async {
                // Here enable capture button due to successfull setup
                self.isCameraButtonDisabled = false
            }
        }
    }
    
    // Function to make camera focus?
